...
app.controller("FormCtrl", function($scope) {
  ...
  $scope.submitAndUpdateRadar = function() {
    ...
    console.log(Object.keys($scope.form))
    console.log(Object.keys($scope.form).length)
    console.log($scope.question_answer)
    console.log(Object.keys($scope.question_answer))
    console.log(Object.keys($scope.question_answer).length)
    console.log(fields)
    console.log(Object.keys(fields))
    console.log(Object.keys(fields).length)
    console.log('_.xor(fields, totalQuestions)')
    console.log(_.xor(fields, totalQuestions))
      var data = {
